...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    ...
    <body>
        ...
        <?php
            ...
            $usuario = $UsuarioDAO->buscaPorPK($usuarioID);
            if($usuario != null) {

        ?>
        <fieldset id="CadastrarUsuario" style="width: 100%; height: 80%;">
                <legend for="CadastrarUsuario">Cadastro de Usuario</legend>
                <form action="CadastrarUsuario.php" method="post">
                    <br>
                    <div align="justify">
                        Login
                            <input name="login" value="<?php echo $usuario->getLogin(); ?>" size="20" maxlength="30">
                        <br><br>
                        CPF
                            <input size="16" maxlength="14" value="<?php echo $usuario->getCpf(); ?>" name="cpf">
                        Senha
                            <input size="14" maxlength="14" name="senha" value="<?php echo $usuario->getSenha(); ?>" type="password">
                            &nbsp; &nbsp; &nbsp;
                             <input name="usuario_id" type="hidden" value="<? echo $usuario->getUsuarioID(); ?>"/>
                        <p align="center">
