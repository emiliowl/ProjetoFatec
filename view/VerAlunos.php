        ...
        <div id="conteudo">
            ...
            <table  id="tbCadastros" width="100%" align="left">
                ...
                <tr align="center" style="font-size:10px;" <?php if($i % 2 == 0) { ?> bgcolor="lightgray"<?php } ?>>
                    <td> <?php echo $alunos[$i]->getNome(); ?> </td>
                    <td> <?php echo $alunos[$i]->getCpf(); ?> </td>
                    <td> <?php echo $alunos[$i]->getRg(); ?> </td>
                    <td> <?php echo $alunos[$i]->getRua(); ?> </td>
                    <td> <?php echo $alunos[$i]->getCidade(); ?> </td>
                    <td> <?php echo $alunos[$i]->getEstado(); ?> </td>
                    <td> <?php echo $alunos[$i]->getTelefone(); ?> </td>
                    <td> <?php echo $alunos[$i]->getRa(); ?> </td>
                    <td> <a href="/ProjetoFatec/view/EditarAluno.php?id=<?php echo $alunos[$i]->getAlunoID(); ?>"> <img src="/ProjetoFatec/images/alterar_64x64.png" width="16px" height="16px" title="editar aluno" border="0"> </a> </td>
                    <td> <a href="/ProjetoFatec/view/ExcluirAluno.php?id=<?php echo $alunos[$i]->getAlunoID(); ?>"> <img src="/ProjetoFatec/images/excluir_64x64.png" width="16px" height="16px" title="excluir aluno" border="0"> </a> </td>
                </tr>
                <?php
                    }
                ?>
