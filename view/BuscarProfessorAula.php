...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    ...
    <body>
        ...
        <div id="conteudo">
           <form method="post" action="BuscaProfessorAula.php">
               <br />
               <br />
               <br />
               <center>
                    Selecione a caracter&iacute;stica pela qual deseja encontrar o professor: <br />
                    <br />
                    <br />
                    <select name="coluna">
                        <option value="nome">Nome
                        <option value="cpf"> CPF
                        <option value="id_professor">ID
                    </select>
                    <input type="text" size="30" maxlength="30" name="item" />
