...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    ...
    <body>
        ...
        <div id="conteudo" align="center">
            ...
            <p align="justify">
                <h2 align="justify">
                    Aula iniciada às: <?php echo $aula->getHoraInicio(); ?><br/>
                    Mat&eacute;ria: <?php echo $materia->getNome(); ?><br/>
                    Professor: <?php echo $professor->getNome(); ?>
                </h2>
            </p>
            <fieldset id="entraAula">
            <legend for="entraAula">Digite seu RA para entrar na Aula</legend>
                <form method="post" action="EntraAula.php">
                    RA
            ...
            <fieldset id="finalizaAula">
            <legend for="finalizaAula">Finalizar Aula</legend>
                <form id="finalizaAula" action="FinalizaAula.php" method="post">
                    <input type="text" name="cpf_digitado" size="16" maxlength="11" />
                    <input type="hidden" value="<?php echo $aulaID;?>" name="aula_id"/>
                    <input type="hidden" value="<?php echo $professor->getCpf();?>" name="cpf"/>
