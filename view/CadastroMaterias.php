            ...
            <div>
                 <center>
                    <table width="90%" align="right" id="tbDefault">
                            <tr>
                                <td align="center"><a href="/ProjetoFatec/view/CadastraMateria.php"> <img id="novaMateria" name="novaMateria" title="nova materia" src="/ProjetoFatec/images/novo_64x64.png" border="0" width="128" height="128" alt="nova materia" /> </a></td>
                                <td align="center"><a href="/ProjetoFatec/view/BuscaMateria.php"> <img id="buscarMateria" name="buscarMateria" title="procurar materia" src="/ProjetoFatec/images/lupa_128x128.png" border="0"  width="128" height="128" alt="procurar materia" /> </a></td>
                                <td align="center"><a href="/ProjetoFatec/view/VerMaterias.php"> <img id="todosMateria" name="todosMaterias" title="ver materias" src="/ProjetoFatec/images/todos_128x128.png" border="0" width="128" height="128" alt="ver materias" /> </a></td>
                            </tr>
                            <tr>
                                <td align="center">NOVA</td>
                                <td align="center">BUSCAR</td>
                                <td align="center">VER TODAS</td>
                            </tr>
                    </table>
                 </center>
                <br><br>
