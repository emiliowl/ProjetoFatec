    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <?php
                ...
                $Usuario = $UsuarioDAO->buscaPorColuna($item, $coluna);
            ...
            <br />
            <p align="right">
                <a href="/ProjetoFatec/view/EditarUsuario.php?id=<?php echo $Usuario->getUsuarioID(); ?>"> <img src="/ProjetoFatec/images/alterar_64x64.png" title="editar professor" border="0"> </a>
                <a href="/ProjetoFatec/view/ExcluirUsuario.php?id=<?php echo $Usuario->getUsuarioID(); ?>"> <img src="/ProjetoFatec/images/excluir_64x64.png" title="excluir professor" border="0"> </a>
            </p>
            <?php
                } else {
                    echo "Usu&aacute;rio nao encontrado.";
                }
            ?>
        </div>
