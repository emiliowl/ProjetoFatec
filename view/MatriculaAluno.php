...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    ...
    <body>
        ...
        <div id="conteudo">
            <fieldset id="MatricularAluno" style="width: 100%; height: 80%;">
                <legend for="MatricularAluno">Matr&iacute;cula de Aluno</legend>
                <form action="MatricularAluno.php" method="post">
                    <br>
                    <div align="justify">
                        <div style="margin-left: 40px;">
                            ...
                            <select name="alunoID">
                                ...
                                ?>
                                        <option value="<?php echo $alunos[$i]->getAlunoID(); ?>" /><?php echo $alunos[$i]->getNome();?>
                                <?php
                                    }
                                ?>
                            </select>
