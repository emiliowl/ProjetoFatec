    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <?php
                ...
                $materia = new Materia($materiaID, $nome, ($cargaHoraria*10000), $professorID, $turmaID);
                $materiaDAO = new MateriaDAO();
                $materiaDAO->insereMateria($materia);
                if($materia->getMateriaID() == 0) {
                    echo "Mat&eacute;ria ".$materia->getNome()." inserida com sucesso!";
                } else {
                    echo "Mat&eacute;ria ".$materia->getNome()." atualizada com sucesso!";
                }
