            ...
            <table border="0" style="width: 100%; height: 60%;">
                <tbody>
                    ...
                    <tr align="center" bgcolor="gray">
                        <td style="width:100%; height:25%;"> <a href="/ProjetoFatec/view/Intranet.php"> <big> Área Protegida </big> </a><br></td>
                    </tr>
                    <tr align="center" bgcolor="lightblue">
            ...
            <div>
                 <center>
                    <table width="90%" align="right" id="tbDefault">
                            <tr>
                                <td align="center"><a href="/ProjetoFatec/view/CadastraProfessor.php"> <img id="novoProfessor" name="novoProfessor" title="novo professor" src="/ProjetoFatec/images/novo_64x64.png" border="0" width="128" height="128" alt="novo professor" /> </a></td>
                                <td align="center"><a href="/ProjetoFatec/view/BuscaProfessor.php"> <img id="buscarProfessor" name="buscarProfessor" title="procurar professor" src="/ProjetoFatec/images/lupa_128x128.png" border="0"  width="128" height="128" alt="procurar professor" /> </a></td>
                                <td align="center"><a href="/ProjetoFatec/view/VerProfessores.php"> <img id="todosProfessores" name="todosProfessores" title="ver professores" src="/ProjetoFatec/images/todos_128x128.png" border="0" width="128" height="128" alt="ver professores" /> </a></td>
                            </tr>
                            <tr>
