                ...
                <form action="CadastrarMateria.php" method="post">
                    ...
                    <div align="justify">
                        <div style="margin-left: 40px;">
                            Nome
                            <input type="text" value="<?php echo $materia->getNome(); ?>" name="nome" size="30" maxlength="30">
                        </div>
                        <br>
                        <div style="margin-left: 40px;">
                            Carga Hor&aacute;ria
                            <input size="5" maxlength="2" name="cargaHoraria" value="<?php echo $materia->getCargaHoraria(); ?>">
                            &nbsp; &nbsp;&nbsp;
                            Professor
                            <?php
                            ...
                            <select name="professorID">
                                ...
                                ?>
                                        <option value="<?php echo $professores[$i]->getProfessorID(); ?>" <?php if($professores[$i]->getProfessorID()==$materia->getProfessorID()){ echo "selected"; } ?> /><?php echo $professores[$i]->getNome();?>
                                <?php
                                    }
                                ?>
                            </select>
                            <br /><br />
                            Turma
                            <input type="text" name="turmaID" size="10" maxlength="10" value="<?php echo $materia->getTurmaID(); ?>" />
                            <input name="materia_id" type="hidden" value="<? echo $materia->getMateriaID(); ?>"/>
                        </div>
                        <br>
                        <p align="center">
