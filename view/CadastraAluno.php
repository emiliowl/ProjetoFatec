                ...
                <form action="CadastrarAluno.php" method="post">
                    ...
                    <div align="justify">
                        <div style="margin-left: 40px;">
                            Nome
                            <input name="nome" size="70" maxlength="30">
                            <img src="" alt="Sua Foto Aqui" name="FOTO" style="background-color: rgb(255, 255, 255);" align="right" border="1" height="128" width="128"><br>
                        </div>
                        <br>
                        <div style="margin-left: 40px;">
                            CPF
                            <input size="24" maxlength="14" name="cpf">
                            &nbsp; &nbsp;&nbsp;
                            RG
                            <input size="30" maxlength="20" name="rg" type="text">
                            <br />
                        </div>
                        <br>
                        <div style="margin-left: 40px;">
                            Rua
                            <input size="20" maxlength="30" name="rua" type="text">
                            Cidade
                            <input size="20" maxlength="30" name="cidade" type="text">
                            <br /><br />
                            Estado
                            <select name="estado">
                        ...
                        <div style="margin-left: 40px;">
                            Telefone
                            <input size="14" maxlength="14" name="telefone" type="text">
                            &nbsp; &nbsp; &nbsp;
                            RA
                            <input size="8" maxlength="8" name="ra" type="text">
                            <br /><br />
                            Impress&atilde;o Digital
                            <input size="20" maxlength="20" name="impressaoDigital" type="text">
                        </div>
                        <p align="center">
