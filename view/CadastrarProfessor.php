    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <?php
                ...
                $impressaoDigital = $_POST['impressaoDigital'];
                $professorID;
                ...
                $Professor = new Professor($nome, $cpf, $rg, $rua, $cidade, $estado, $telefone, $impressaoDigital, $professorID);
                $ProfessorDAO = new ProfessorDAO();
                $ProfessorDAO->insereProfessor($Professor);
                if($Professor->getProfessorID() == 0) {
                    echo "Professor ".$Professor->getNome()." inserido com sucesso!";
                } else {
                    echo "Professor ".$Professor->getNome()." atualizado com sucesso!";
                }
