    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <?php
                ...
                $Aluno = new Aluno($nome, $cpf, $rg, $rua, $cidade, $estado, $telefone, $impressaoDigital, $ra, $alunoID);
                $AlunoDAO = new AlunoDAO();
                $AlunoDAO->insereAluno($Aluno);
                if($Aluno->getAlunoID() == 0) {
                    echo "Aluno ".$Aluno->getNome()." inserido com sucesso!";
                } else {
                    echo "Aluno ".$Aluno->getNome()." atualizado com sucesso!";
                }
