    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <table id="tbDefault" width="100%" align="left">
                ...
                <tr>
                    <td>Rua</td>
                    <td><?php echo $Aluno->getRua(); ?></td>
                </tr>
                <tr bgcolor="lightgray">
                    <td>Cidade</td>
                    <td><?php echo $Aluno->getCidade(); ?></td>
                </tr>
                <tr>
                    <td>Estado</td>
                    <td><?php echo $Aluno->getEstado(); ?></td>
                </tr>
                <tr bgcolor="lightgray">
                    <td>Telefone</td>
            ...
            <br />
            <p align="right">
                <a href="/ProjetoFatec/view/EditarAluno.php?id=<?php echo $Aluno->getAlunoID(); ?>"> <img src="/ProjetoFatec/images/alterar_64x64.png" title="editar aluno" border="0"> </a>
                <a href="/ProjetoFatec/view/ExcluirAluno.php?id=<?php echo $Aluno->getAlunoID(); ?>"> <img src="/ProjetoFatec/images/excluir_64x64.png" title="excluir aluno" border="0"> </a>
            </p>
            <?php
                } else {
