...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    ...
    <body>
        ...
        <?php
            ...
            include '../beans/Aluno.php';
            include_once '../database/dao/AlunoDAO.php';
            include_once '../database/FabricaConexoes.php';
            
            $alunoID = $_GET['id'];
            $AlunoDAO = new AlunoDAO();
            $aluno = $AlunoDAO->buscaPorPK($alunoID);
            if($aluno != null) {
            
        ?>
            <fieldset id="CadastrarAluno" style="width: 100%; height: 80%;">
                <legend for="CadastrarAluno">Cadastro de Aluno</legend>
                <form action="CadastrarAluno.php" method="post">
                    <br>
                    <div align="justify">
                        <div style="margin-left: 40px;">
                            Nome
                            <input name="nome" value="<? echo $aluno->getNome() ?>" size="70" maxlength="30">
                            <img src="" alt="Sua Foto Aqui" name="FOTO" style="background-color: rgb(255, 255, 255);" align="right" border="1" height="128" width="128"><br>
                        </div>
                        <br>
                        <div style="margin-left: 40px;">
                            CPF
                            <input size="24" value="<? echo $aluno->getCpf() ?>" maxlength="14" name="cpf">
                            &nbsp; &nbsp;&nbsp;
                            RG
                            <input size="30" value="<? echo $aluno->getRg() ?>" maxlength="20" name="rg" type="text">
                            <br />
                        </div>
                        <br>
                        <div style="margin-left: 40px;">
                            Rua
                            <input size="25" value="<? echo $aluno->getRua() ?>" maxlength="30" name="rua" type="text">
                            Cidade
                            <input size="25" value="<? echo $aluno->getCidade() ?>" maxlength="30" name="cidade" type="text">
                            <br /><br />
                            Estado
                            <select name="estado">
                        ...
                        <div style="margin-left: 40px;">
                            Telefone
                            <input size="14" value="<? echo $aluno->getTelefone() ?>" maxlength="14" name="telefone" type="text">
                            &nbsp; &nbsp; &nbsp;
                            RA
                            <input size="8" value="<? echo $aluno->getRa() ?>" maxlength="8" name="ra" type="text">
                            <br /><br />
                            Impress&atilde;o Digital
                            <input size="20" value="<? echo $aluno->getImpressaoDigital() ?>" maxlength="20" name="impressaoDigital" type="text">
                            <input name="aluno_id" type="hidden" value="<? echo $aluno->getAlunoID(); ?>"/>
                        </div>
                        <p align="center">
