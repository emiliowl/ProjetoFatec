    ...
    <body>
        ...
        <div id="conteudo">
            <fieldset id="CadastrarUsuario" style="width: 100%; height: 80%;">
                <legend for="CadastrarUsuario">Cadastro de Usu&aacute;rio</legend>
                <form action="CadastrarUsuario.php" method="post">
                    <br>
                    <div align="justify">
                        Login
                            <input name="login" size="20" maxlength="30">
                        <br><br>
                        CPF
                            <input size="16" maxlength="14" name="cpf">
                        Senha
                            <input size="14" maxlength="14" name="senha" type="password">
                            &nbsp; &nbsp; &nbsp;
                        <p align="center">
