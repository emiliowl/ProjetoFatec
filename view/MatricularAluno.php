    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <?php
                ...
                $matricula = new Matricula(0, $materia->getMateriaID(), $aluno->getAlunoID(), $materia->getTurmaID(), 1);
                $matriculaDAO->insereMatricula($matricula);
                echo "Aluno ".$aluno->getNome().", matriculado com sucesso na disciplina ".$materia->getNome().".";
